...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') 
{
    ...
    if ($file && move_uploaded_file($_FILES['archivo']['tmp_name'],$dir.$nom_arch))
    {
        ...
        if($filtro=="descanso"){
            ...
            $sql2 = "INSERT INTO materialesxtema (TEMA,TIPO,DETALLE) VALUES ('$idT','$fechaF','$fechaI')";
            ...
            $sql = "INSERT INTO noticias (TITULO,DETALLE) VALUES ('$empleado','$fechaI')";
            ...
            $sql2 = "INSERT INTO materialesxnoticia (NOTICIA,TIPO,DETALLE) VALUES ('$idT','$fechaF','$fechaI')";
